...
import com.cse.warana.utility.AggregatedProfileGenerator.jate.core.algorithm.AverageCorpusTFAlgorithm;
import com.cse.warana.utility.AggregatedProfileGenerator.jate.core.algorithm.AverageCorpusTFFeatureWrapper;
...
public class TestAverageCorpusTF {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(TestAverageCorpusTF.class);
