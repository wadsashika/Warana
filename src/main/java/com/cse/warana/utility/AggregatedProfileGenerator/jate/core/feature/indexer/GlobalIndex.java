...
public abstract class GlobalIndex {
    public int _termCounter = 0;
	public int _variantCounter = 0;
	public int _docCounter = 0;
	 ...
	 * @return the id
	 */
	public abstract int indexTermCanonical(String term);
	 ...
	 * @return the id
	 */
	public abstract int indexTermVariant(String termV) ;
	 ...
	 * @return
	 */
	public abstract String retrieveTermVariant(int id) ;
	 ...
	 * @return the id
	 */
	public abstract int indexDocument(Document d);
	 ...
	 * @param map
	 */
	public abstract void indexTermWithVariant(Map<String, Set<String>> map);
	 ...
	 * @param d
	 */
	public abstract void indexTermCanonicalInDoc(String t, Document d);
	 ...
	 * @param d
	 */
	public abstract void indexTermCanonicalInDoc(int t, int d) ;
	 ...
	 */
	public abstract  void indexDocWithTermsCanonical(Document d, Set<String> terms);
	 ...
	 * @param terms canonical forms of candidate terms found in document d
	 */
	public abstract void indexDocWithTermsCanonical(int d, Set<Integer> terms);
