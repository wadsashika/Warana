...
/**
 * Created by Thilina on 11/2/2014.
 */
...
//		if (args.length < 3) System.out.println("Usage: java PhraseAnalyzer [corpus_path] [reference_corpus_path] [output_folder]");
        if (false) System.out.println("Usage: java PhraseAnalyzer [corpus_path] [reference_corpus_path] [output_folder]");
            ...
            try {
                ...
                GlobalIndexMem wordDocIndex = builder.build(new CorpusImpl(srcPath), wordextractor);
                GlobalIndexMem termDocIndex = builder.build(new CorpusImpl(srcPath), npextractor);
                ...
                // GlobalIndexWriterHSQL.persist(termDocIndex, "D:/work/JATR_SDK/jate_googlecode/com.cse.warana.utility.AggregatedProfileGenerator.PhraseExtractor.nlp_resources.test/output/termdb");
                ...
                */
                ...
                //##########################################################
                //#         Step 3. For each algorithm you want to com.cse.warana.utility.AggregatedProfileGenerator.PhraseExtractor.nlp_resources.test    #
