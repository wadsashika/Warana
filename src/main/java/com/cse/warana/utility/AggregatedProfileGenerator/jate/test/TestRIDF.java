...
import com.cse.warana.utility.AggregatedProfileGenerator.jate.core.algorithm.RIDFAlgorithm;
import com.cse.warana.utility.AggregatedProfileGenerator.jate.core.algorithm.RIDFFeatureWrapper;
...
public class TestRIDF {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(TestRIDF.class);
