...
public class GlobalIndexMem extends GlobalIndex {
     ...
     * Term to TermId map
     */
    public HashMap<String, Integer> _termIdMap = new HashMap<String, Integer>();

    /**
     * TermId to Term map (array index is TermID)
     */
    public ArrayList<String> _terms = new ArrayList<String>();

    /**
     * Variant to VariantId map
     */
    public HashMap<String, Integer> _variantIdMap = new HashMap<String, Integer>();

    /**
     * VariantId to Variant map (array index is VariantID)
     */
    public ArrayList<String> _variants = new ArrayList<String>();

    /**
     * Document to DocumentId map
     */
    public HashMap<Document, Integer> _docIdMap = new HashMap<Document, Integer>();

    /**
     * DocumentId to Document map (array index is DocumentID)
     */
    public ArrayList<Document> _documents = new ArrayList<Document>();


    public Map<Integer, Set<Integer>> _term2Docs = new HashMap<Integer, Set<Integer>>();
    public Map<Integer, Set<Integer>> _doc2Terms = new HashMap<Integer, Set<Integer>>();
    public Map<Integer, Set<Integer>> _term2Variants = new HashMap<Integer, Set<Integer>>();
    public Map<Integer, Integer> _variant2term = new HashMap<Integer, Integer>();
     ...
     * @return the id
     */
    public int indexTermCanonical(String term) {
     ...
     * @return the id
     */
    public int indexTermVariant(String termV) {
     ...
     * @return
     */
    public String retrieveTermVariant(int id) {
     ...
     * @return the id
     */
    public int indexDocument(Document d) {
...
//        return null;
     ...
     * @param map
     */
    public void indexTermWithVariant(Map<String, Set<String>> map) {
     ...
     * @param d
     */
    public void indexTermCanonicalInDoc(String t, Document d) {
     ...
     * @param d
     */
    public void indexTermCanonicalInDoc(int t, int d) {
     ...
     */
    public void indexDocWithTermsCanonical(Document d, Set<String> terms) {
     ...
     * @param terms canonical forms of candidate terms found in document d
     */
    public void indexDocWithTermsCanonical(int d, Set<Integer> terms) {
